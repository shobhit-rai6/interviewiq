...
function Step1SetUp({ onStart }) {
    ...
    const handleStart = async () => {
        ...
        if (userData && userData.credits < 50) {
            setError("Not enough credits. Please purchase more credits to start an interview.")
            return
        }
        setLoading(true)
        try {
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                ...
                <motion.div
                    ...
                    <div className='space-y-6'>
                        ...
                        <div>
                            <p className='text-sm text-gray-500 mb-2'>AI Interviewer</p>
                            <div className='flex gap-3'>
                                {["female", "male"].map((g) => (
                                    <button
                                        ...
                                        className={`flex-1 py-2 rounded-xl border text-sm font-medium transition ${aiGender === g ? "bg-green-600 text-white border-green-600" : "border-gray-200 text-gray-600 hover:border-green-400"}`}
                                    >
